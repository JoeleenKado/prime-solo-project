...
const theme = createMuiTheme({
  ...
  typography: {
    fontFamily: ["cursive", "Chilanka"].join(","),
  },
});
    ...
    return (
      <ThemeProvider theme="">
        ...
        <div>
          ...
          <Grid container spacing={8} className={classes.styleContainer}>
            {/* // className={classes.inputs}> */}

            {/* {art.map((art) => ( */}
            <Grid item xs={12} sm={12} key={art.id}>
              <Card
              ...
              >
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    className={classes.centerText}
                  >
                    To get started. Head over to the Gallery where you can
                    upload art.
                    <br />
                  </Typography>
                </CardContent>
            ...
            {/*  */}
            {/* {art.map((art) => ( */}
            <Grid item xs={12} sm={4} key={art.id}></Grid>
          </Grid>
        </div>
      </ThemeProvider>
    ); //END return
